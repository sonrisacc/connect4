...
const checkWinner = (board, r, c, value) => {
  ...
  // check horizontal
  if (checkHoriZontalDirection(r, c, value, board)) return true;
  // check vertical
  if (checkVirticalDirection(r, c, value, board)) return true;
  // check diagnol
  if (checkMajorDirection(r, c, value, board)) return true;
  if (checkMinorDirection(r, c, value, board)) return true;
  return false;
};
